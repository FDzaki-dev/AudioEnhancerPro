...
// Section ini SENGAJA cuma nampilkan versi app + 1 tombol cek + status teks — TIDAK
// duplikasi UI unduh/pasang (progress bar dkk sudah ada di UpdateBanner); begitu tombol
// di sini ketemu update, `BoosterViewModel.updateInfo` ikut ke-set (lihat
// checkForUpdateManually()), jadi UpdateBanner otomatis muncul lagi pas user balik ke
// layar utama — 0 duplikasi logic unduh.
            ...
            Column(modifier = Modifier.padding(16.dp).fillMaxWidth()) {
                ...
                val statusText = when (manualUpdateCheckState) {
                    ...
                    BoosterViewModel.ManualUpdateCheckState.FOUND ->
                        stringResource(R.string.settings_update_found, foundUpdateInfo?.versionName ?: "")
